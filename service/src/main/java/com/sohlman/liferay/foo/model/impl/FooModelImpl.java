...
import com.sohlman.liferay.foo.model.FooModel;
import com.sohlman.liferay.foo.model.FooSoap;
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final String TABLE_SQL_CREATE = "create table Foo_Foo (uuid_ VARCHAR(75) null,fooId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,payload VARCHAR(75) null)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.sohlman.liferay.foo.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.sohlman.liferay.foo.model.Foo"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.sohlman.liferay.foo.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.sohlman.liferay.foo.model.Foo"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.sohlman.liferay.foo.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.sohlman.liferay.foo.model.Foo"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.sohlman.liferay.foo.service.util.ServiceProps.get(
				"lock.expiration.time.com.sohlman.liferay.foo.model.Foo"));
	...
	public CacheModel<Foo> toCacheModel() {
		...
		fooCacheModel.payload = getPayload();

		String payload = fooCacheModel.payload;

		if ((payload != null) && (payload.length() == 0)) {
			fooCacheModel.payload = null;
		}
	...
	public String toXmlString() {
		...
		sb.append("com.sohlman.liferay.foo.model.Foo");
