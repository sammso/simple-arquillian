 ...
 * @see FooModel
 * @see com.sohlman.liferay.foo.model.impl.FooImpl
 * @see com.sohlman.liferay.foo.model.impl.FooModelImpl
 * @generated
 */
@ImplementationClassName("com.sohlman.liferay.foo.model.impl.FooImpl")
@ProviderType
public interface Foo extends FooModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link com.sohlman.liferay.foo.model.impl.FooImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
