...
public interface FooPersistence extends BasePersistence<Foo> {
	...
	* @return the matching foos
	*/
	public java.util.List<Foo> findByGroup(long groupId);
	...
	* @return the range of matching foos
	*/
	public java.util.List<Foo> findByGroup(long groupId, int start, int end);
	...
	* @return the matching foos
	*/
	public java.util.List<Foo> findByCompany(long companyId);
	...
	* @return the range of matching foos
	*/
	public java.util.List<Foo> findByCompany(long companyId, int start, int end);
	...
	* @return the ordered range of matching foos
	*/
	public java.util.List<Foo> findByCompany(long companyId, int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<Foo> orderByComparator);
