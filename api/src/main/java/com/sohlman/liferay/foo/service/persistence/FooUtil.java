...
package com.sohlman.liferay.foo.service.persistence;
 ...
 * @see FooPersistence
 * @see com.sohlman.liferay.foo.service.persistence.impl.FooPersistenceImpl
 * @generated
 */
@ProviderType
public class FooUtil {
	...
	*/
	public static Foo findByUuid_First(java.lang.String uuid,
		...
		throws com.sohlman.liferay.foo.exception.NoSuchFooException {
	...
	* @return the matching foos
	*/
	public static List<Foo> findByGroup(long groupId) {
	...
	* @return the range of matching foos
	*/
	public static List<Foo> findByGroup(long groupId, int start, int end) {
	...
	* @throws NoSuchFooException if a matching foo could not be found
	*/
	public static Foo findByGroup_First(long groupId,
		OrderByComparator<Foo> orderByComparator)
		throws com.sohlman.liferay.foo.exception.NoSuchFooException {
	...
	* @return the first matching foo, or <code>null</code> if a matching foo could not be found
	*/
	public static Foo fetchByGroup_First(long groupId,
		OrderByComparator<Foo> orderByComparator) {
	...
	* @throws NoSuchFooException if a matching foo could not be found
	*/
	public static Foo findByGroup_Last(long groupId,
		OrderByComparator<Foo> orderByComparator)
		throws com.sohlman.liferay.foo.exception.NoSuchFooException {
	...
	* @return the last matching foo, or <code>null</code> if a matching foo could not be found
	*/
	public static Foo fetchByGroup_Last(long groupId,
		OrderByComparator<Foo> orderByComparator) {
	...
	* @throws NoSuchFooException if a foo with the primary key could not be found
	*/
	public static Foo[] findByGroup_PrevAndNext(long fooId, long groupId,
		OrderByComparator<Foo> orderByComparator)
		throws com.sohlman.liferay.foo.exception.NoSuchFooException {
		return getPersistence()
	...
	* @return the matching foos
	*/
	public static List<Foo> findByCompany(long companyId) {
	...
	* @return the range of matching foos
	*/
	public static List<Foo> findByCompany(long companyId, int start, int end) {
	...
	* @throws NoSuchFooException if a matching foo could not be found
	*/
	public static Foo findByCompany_First(long companyId,
		OrderByComparator<Foo> orderByComparator)
		throws com.sohlman.liferay.foo.exception.NoSuchFooException {
	...
	* @return the first matching foo, or <code>null</code> if a matching foo could not be found
	*/
	public static Foo fetchByCompany_First(long companyId,
		OrderByComparator<Foo> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchFooException if a matching foo could not be found
	*/
	public static Foo findByCompany_Last(long companyId,
		OrderByComparator<Foo> orderByComparator)
		throws com.sohlman.liferay.foo.exception.NoSuchFooException {
	...
	* @return the last matching foo, or <code>null</code> if a matching foo could not be found
	*/
	public static Foo fetchByCompany_Last(long companyId,
		OrderByComparator<Foo> orderByComparator) {
	...
	* @throws NoSuchFooException if a foo with the primary key could not be found
	*/
	public static Foo[] findByCompany_PrevAndNext(long fooId, long companyId,
		OrderByComparator<Foo> orderByComparator)
		throws com.sohlman.liferay.foo.exception.NoSuchFooException {
		return getPersistence()
				   .findByCompany_PrevAndNext(fooId, companyId,
			orderByComparator);
	}
