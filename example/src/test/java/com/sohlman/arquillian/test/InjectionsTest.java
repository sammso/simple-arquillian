...
import com.sohlman.arquillian.sample.service4injection.Service;
import com.sohlman.arquillian.sample.service4injection.ServiceFirstImpl;
import com.sohlman.arquillian.sample.service4injection.ServiceSecondImpl;
...
public class InjectionsTest {
	...
	public void testInjectBundle() {
		...
		Assert.assertEquals(
			"com.sohlman.arquillian.sample", _bundle.getSymbolicName());
	}
